# Lakehouse Platform Reference Architecture

**Domain:** Data Architecture | **Repository:** enterprise-reference-architectures
...
Modern lakehouse with Bronze/Silver/Gold medallion layers, Delta Lake, and Unity Catalog.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a lakehouse platform platform at enterprise scale.
