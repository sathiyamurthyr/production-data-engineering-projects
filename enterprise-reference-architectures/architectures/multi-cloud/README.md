# Multi-Cloud Platform Reference Architecture

**Domain:** Cloud | **Repository:** enterprise-reference-architectures
...
Multi-cloud platform across Azure, AWS, and GCP with unified governance.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a multi-cloud platform platform at enterprise scale.
