...
**Domain:** E-Commerce | **Repository:** enterprise-reference-architectures
...
Modern e-commerce platform with catalog, cart, order management, and personalization.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a e-commerce platform platform at enterprise scale.
