# Insurance Platform Reference Architecture

**Domain:** Insurance | **Repository:** enterprise-reference-architectures
...
Insurance platform with policy management, claims processing, underwriting, and actuarial analytics.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a insurance platform platform at enterprise scale.
