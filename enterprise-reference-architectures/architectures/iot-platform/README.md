...
**Domain:** IoT | **Repository:** enterprise-reference-architectures
...
Enterprise IoT platform ingesting billions of device events with real-time processing and analytics.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a iot platform platform at enterprise scale.
