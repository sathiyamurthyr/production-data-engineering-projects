# Metadata Platform Reference Architecture

**Domain:** Governance | **Repository:** enterprise-reference-architectures
...
Enterprise metadata platform with data catalog, lineage, and business glossary.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a metadata platform platform at enterprise scale.
