# AI Knowledge Platform Reference Architecture

**Domain:** AI | **Repository:** enterprise-reference-architectures
...
Enterprise AI knowledge platform with RAG, vector search, and LLM integration.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a ai knowledge platform platform at enterprise scale.
