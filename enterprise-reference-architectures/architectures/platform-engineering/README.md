...
**Domain:** Platform | **Repository:** enterprise-reference-architectures
...
Internal developer platform with self-service, golden paths, and infrastructure as code.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a platform engineering platform at enterprise scale.
