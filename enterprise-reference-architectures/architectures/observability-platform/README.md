...
**Domain:** SRE | **Repository:** enterprise-reference-architectures
...
Full-stack observability platform with metrics, logs, traces, and SLOs.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a observability platform platform at enterprise scale.
