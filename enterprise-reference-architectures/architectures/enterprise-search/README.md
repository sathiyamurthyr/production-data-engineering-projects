# Enterprise Search Reference Architecture

**Domain:** Search | **Repository:** enterprise-reference-architectures
...
Unified enterprise search across all corporate data with semantic understanding.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a enterprise search platform at enterprise scale.
