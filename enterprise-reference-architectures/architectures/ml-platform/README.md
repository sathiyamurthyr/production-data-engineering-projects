...
**Domain:** MLOps | **Repository:** enterprise-reference-architectures
...
Enterprise ML platform with feature store, model registry, training, and serving.

## Architecture Summary

This reference architecture provides a complete, production-grade blueprint for
building and operating a ml platform platform at enterprise scale.
